...
%token VOID 
%token <nd_obj> CHARACTER PRINTX INT FLOAT CHAR FOR IF ELSE TRUE FALSE NUMBER FLOAT_NUM ID LE GE EQ NE GT LT AND OR STR ADD MULTIPLY DIVIDE SUBTRACT UNARY 
%type <nd_obj>  body datatype statement arithmetic relop program else
%type <nd_obj2> init value expression
%type <nd_obj3> condition

%%

program:  body {$$.nd = mknode(NULL, $1.nd, "program"); 
	head = $$.nd;
} 
;
...
| PRINTX { add('K'); } '(' STR ')' ';' { $$.nd = mknode(NULL, NULL, "print"); }
;
